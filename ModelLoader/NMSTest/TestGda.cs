...
namespace NMSTest
{
    public class TestGda : IDisposable
    {
        ...
        public async Task<UpdateResult> TestApplyDeltaUpdate(List<long> gids)
        {
        ...
        public async Task<UpdateResult> TestApplyDeltaInsertUpdateDelete()
        {
            UpdateResult updateResult = null;

            try
            {
                updateResult = await TestApplyDeltaInsert();
                ...
                if (updateResult != null && updateResult.Result == ResultType.Succeeded)
                {
                    ...
                    updateResult = await TestApplyDeltaUpdate(gids);

                    updateResult = await TestApplyDeltaDelete(gids);
                }
            }
            catch (Exception ex)
            {
        ...
        public async Task TestApplyDeltaInsertUpdate(long modelVersionId)
        {
            UpdateResult updateResult = null;
            try
            {
