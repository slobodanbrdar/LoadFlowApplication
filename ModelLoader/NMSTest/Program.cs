            ...
            try
            {
                ...
                do
                {
                    ...
                    if (str == "1")
                    {
                        try
                        {
                            tgda.GetValues(InputGlobalId()).Wait();
                        }
                        catch (Exception ex)
                        {
                    ...
                    else if (str == "2")
                    {
                        try
                        {
                            tgda.GetExtentValues(InputModelCode()).Wait();
                        }
                        catch (Exception ex)
                        {
                    ...
                    else if (str == "3")
                    {
                        try
                        {
                            tgda.GetRelatedValues(InputGlobalId(), InputAssociation()).Wait();
                        }
                        catch (Exception ex)
                        {
                    ...
                    //    try
                    //    {
                    //        tgda.TestApplyDeltaInsert().Wait();
                    //    }
                    //    catch (Exception ex)
                    //    {
                    ...
                    else if (str == "5")
                    {
                        try
                        {
                            long version = tgda.TestGetversion().Result;
