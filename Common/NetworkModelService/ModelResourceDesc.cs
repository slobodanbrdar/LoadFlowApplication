...
namespace Common.NetworkModelService
{
	...
	public class ModelResourcesDesc
	{
		...
		/// <summary>
		/// All types that represent classic branches - conducting equipment without EnergySource and Switch
		/// </summary>
		public List<ModelCode> ClassicBranches { get; set; }

		/// <summary>
		/// Elements that's not nodes nor branches (or terminals). Etc base voltages, transformer ends,...
		/// </summary>
		...
		private void InitializeTypeIdsInInsertOrder()
		{
			...
			typeIdsInInsertOrder.Add(ModelCode.PTRANSFORMEREND);
		...
		private void InitializeNotSettablePropertyIds()
		{
			...
			notSettablePropertyIds.Add(ModelCode.POWERTRANSFORMER_TRANSFORMERENDS);
