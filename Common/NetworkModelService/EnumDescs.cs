...
namespace Common.NetworkModelService
{
	public class EnumDescs
	{
		...
		public EnumDescs()
		{
			property2enumType.Add(ModelCode.ENERGYCONSUMER_GROUNDED, typeof(WindingConnection));
			property2enumType.Add(ModelCode.ENERGYCONSUMER_PHASECONNECTION, typeof(PhaseShuntConnectionKind));
			property2enumType.Add(ModelCode.PTRANSFORMEREND_CONNKIND, typeof(WindingConnection));
